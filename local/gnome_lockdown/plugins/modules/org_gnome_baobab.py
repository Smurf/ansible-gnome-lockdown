...
DOCUMENTATION = r'''
---
module: org_gnome_baobab
short_description: Manages GNOME GSettings for org.gnome.baobab
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.baobab' schema.
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.baobab
  org_gnome_baobab:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_baobab")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_baobab")

    schema_full_path = "/org/gnome/baobab/"
