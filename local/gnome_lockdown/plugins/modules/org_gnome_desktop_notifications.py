...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_notifications
short_description: Manages GNOME GSettings for org.gnome.desktop.notifications
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.notifications' schema.
...
options:
  ...
  application-children:
    ...
    type: str
    default: '[]'
  application-children_locked:
    description:
      - "If set to true, locks the 'application-children' key to prevent user modification."
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.notifications
  org_gnome_desktop_notifications:
    show-banners: True
    show-banners_locked: true
    show-in-lock-screen: True
    show-in-lock-screen_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_notifications")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_notifications")

    schema_full_path = "/org/gnome/desktop/notifications/"
