...
DOCUMENTATION = r'''
---
module: org_gnome_portal
short_description: Manages GNOME GSettings for org.gnome.portal
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.portal' schema.
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.portal
  org_gnome_portal:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_portal")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_portal")

    schema_full_path = "/org/gnome/portal/"
