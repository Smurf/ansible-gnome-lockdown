...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_peripherals
short_description: Manages GNOME GSettings for org.gnome.desktop.peripherals
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.peripherals' schema.
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.peripherals
  org_gnome_desktop_peripherals:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_peripherals")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_peripherals")

    schema_full_path = "/org/gnome/desktop/peripherals/"
