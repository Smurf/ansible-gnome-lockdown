...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_break-reminders
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_break-reminders")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_break-reminders")
