...
DOCUMENTATION = r'''
---
module: org_gnome_settings-daemon_plugins
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.plugins
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.plugins' schema.
...
options:
  whitelisted-plugins:
    ...
    type: str
    default: '['all']'
  whitelisted-plugins_locked:
    description:
      - "If set to true, locks the 'whitelisted-plugins' key to prevent user modification."
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins
  org_gnome_settings-daemon_plugins:
    whitelisted-plugins: '['all']'
    whitelisted-plugins_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_settings-daemon_plugins")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_settings-daemon_plugins")

    schema_full_path = "/org/gnome/settings-daemon/plugins/"
