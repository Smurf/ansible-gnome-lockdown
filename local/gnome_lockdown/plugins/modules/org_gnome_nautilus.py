...
DOCUMENTATION = r'''
---
module: org_gnome_nautilus
short_description: Manages GNOME GSettings for org.gnome.nautilus
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.nautilus' schema.
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.nautilus
  org_gnome_nautilus:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_nautilus")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_nautilus")

    schema_full_path = "/org/gnome/nautilus/"
