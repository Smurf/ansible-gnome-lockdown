...
DOCUMENTATION = r'''
---
module: org_gnome_FileRoller
short_description: Manages GNOME GSettings for org.gnome.FileRoller
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.FileRoller' schema.
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.FileRoller
  org_gnome_FileRoller:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_FileRoller")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_FileRoller")

    schema_full_path = "/org/gnome/file-roller/"
