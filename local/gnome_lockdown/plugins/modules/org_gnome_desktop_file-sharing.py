...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_file-sharing
short_description: Manages GNOME GSettings for org.gnome.desktop.file-sharing
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.file-sharing' schema.
...
options:
  require-password:
    ...
    type: str
    default: 'never'
  require-password_locked:
    description:
      - "If set to true, locks the 'require-password' key to prevent user modification."
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.file-sharing
  org_gnome_desktop_file-sharing:
    require-password: 'never'
    require-password_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_file-sharing")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_file-sharing")

    schema_full_path = "/org/gnome/desktop/file-sharing/"
