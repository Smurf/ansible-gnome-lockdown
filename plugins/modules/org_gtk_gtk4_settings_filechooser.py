...
DOCUMENTATION = r'''
---
module: org_gtk_gtk4_settings_filechooser
short_description: Manages GNOME GSettings for org.gtk.gtk4.Settings.FileChooser
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.gtk4.Settings.FileChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.gtk4.Settings.FileChooser")

    schema_full_path = "/org/gtk/gtk4/settings/file-chooser/"
