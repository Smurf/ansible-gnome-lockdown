...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_peripherals_touchscreen
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.peripherals.touchscreen
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.peripherals.touchscreen' schema.
  - >
...
options:
  ...
  orientation-lock_locked:
    description:
    - >
      If set to true, locks the 'orientation-lock' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.peripherals.touchscreen
  org_gnome_settings_daemon_peripherals_touchscreen:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.peripherals.touchscreen")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.peripherals.touchscreen")

    schema_full_path = "/org/gnome/settings-daemon/peripherals/touchscreen/"
