...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_default_applications_terminal
short_description: Manages GNOME GSettings for org.gnome.desktop.default-applications.terminal
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.default-applications.terminal' schema.
  - >
...
options:
  ...
  exec-arg:
    ...
    - "Argument used to execute programs in the terminal defined by the \n        'exec'\
      \ key.\n\n        DEPRECATED: This key is deprecated and ignored.\n        The default\
      \ terminal and how to invoke it is handled in GIO."
    type: str
    default: -x
  ...
  exec-arg_locked:
    description:
    - >
      If set to true, locks the 'exec-arg' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.default-applications.terminal
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.default-applications.terminal")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.default-applications.terminal")

    schema_full_path = "/org/gnome/desktop/applications/terminal/"
