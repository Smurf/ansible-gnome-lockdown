...
DOCUMENTATION = r'''
---
module: org_gnome_system_proxy_ftp
short_description: Manages GNOME GSettings for org.gnome.system.proxy.ftp
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.system.proxy.ftp' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.system.proxy.ftp
  org_gnome_system_proxy_ftp:
    host: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.system.proxy.ftp")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.system.proxy.ftp")

    schema_full_path = "/system/proxy/ftp/"
