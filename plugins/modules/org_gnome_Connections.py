...
DOCUMENTATION = r'''
---
module: org_gnome_Connections
short_description: Manages GNOME GSettings for org.gnome.Connections
description:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_Connections")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_Connections")

    schema_full_path = "/org/gnome/Connections/"
