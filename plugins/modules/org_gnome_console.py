...
- name: Configure and lock GNOME desktop settings for org.gnome.Console
  org_gnome_console:
    ...
    ignore-scrollback-limit: false

    scrollback-lines: 10000

    last-window-size: (-1, -1)
    ...
    livery: 9f1374fd-f199-429f-bae6-9cf1260f6e3e
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.Console")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.Console")
