...
DOCUMENTATION = r'''
---
module: org_freedesktop_tracker3_extract
short_description: Manages GNOME GSettings for org.freedesktop.Tracker3.Extract
description:
  - >
...
options:
  ...
  wait-for-miner-fs:
    ...
    - When true, tracker-extract will wait for tracker-miner-fs to be done crawling before
      extracting meta-data. This option is useful on constrained environment where it
      is important to list files as fast as possible and can wait to get meta-data later.
    type: bool
    default: false
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.freedesktop.Tracker3.Extract")
    lock_file_path = os.path.join(locks_dir, "ansible-org.freedesktop.Tracker3.Extract")

    schema_full_path = "/org/freedesktop/tracker/extract/"
