...
DOCUMENTATION = r'''
---
module: org_gnome_shell_app_switcher
short_description: Manages GNOME GSettings for org.gnome.shell.app-switcher
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.shell.app-switcher' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.shell.app-switcher
  org_gnome_shell_app_switcher:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.shell.app-switcher")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.shell.app-switcher")

    schema_full_path = "/org/gnome/shell/app-switcher/"
