...
DOCUMENTATION = r'''
---
module: org_gnome_nm-applet_eap
short_description: Manages GNOME GSettings for org.gnome.nm-applet.eap
description:
  - This module allows for the configuration of GSettings keys within the 'org.gnome.nm-applet.eap' schema.
...
options:
  ignore-ca-cert:
    ...
    type: bool
    default: False
  ignore-ca-cert_locked:
    description:
      - "If set to true, locks the 'ignore-ca-cert' key to prevent user modification."
    type: bool
    default: false
  ignore-phase2-ca-cert:
    ...
    type: bool
    default: False
  ignore-phase2-ca-cert_locked:
    description:
      - "If set to true, locks the 'ignore-phase2-ca-cert' key to prevent user modification."
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.nm-applet.eap
  org_gnome_nm-applet_eap:
    ignore-ca-cert: False
    ignore-ca-cert_locked: true
    ignore-phase2-ca-cert: False
    ignore-phase2-ca-cert_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_nm-applet_eap")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_nm-applet_eap")
