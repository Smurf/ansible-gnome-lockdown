...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_stats
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.stats
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.stats' schema.
  - >
...
options:
  ...
  enable-cpu-poll_locked:
    description:
    - >
      If set to true, locks the 'enable-cpu-poll' key to prevent user modification.
    type: bool
    default: false
  enable-disk-poll:
    description:
  ...
  enable-disk-poll_locked:
    description:
    - >
      If set to true, locks the 'enable-disk-poll' key to prevent user modification.
    type: bool
    default: false
  enable-net-poll:
    description:
  ...
  enable-net-poll_locked:
    description:
    - >
      If set to true, locks the 'enable-net-poll' key to prevent user modification.
    type: bool
    default: false
  enable-memory-poll:
    description:
  ...
  enable-memory-poll_locked:
    description:
    - >
      If set to true, locks the 'enable-memory-poll' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.stats
  org_virt_manager_virt_manager_stats:
    update-interval: 3

    enable-cpu-poll: true

    enable-disk-poll: false

    enable-net-poll: false

    enable-memory-poll: false
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.stats")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.stats")

    schema_full_path = "/org/virt-manager/virt-manager/stats/"
