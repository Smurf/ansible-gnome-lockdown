...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_plugins_sharing_service
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.plugins.sharing.service
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.plugins.sharing.service' schema.
  - >
...
options:
  ...
  enabled-connections_locked:
    description:
    - >
      If set to true, locks the 'enabled-connections' key to prevent user modification.
    type: bool
    default: false
'''
...
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins.sharing.service
  org_gnome_settings_daemon_plugins_sharing_service:
    enabled-connections: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.plugins.sharing.service")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.plugins.sharing.service")
