...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_details
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.details
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.details' schema.
  - >
...
options:
  show-toolbar:
    ...
    - Whether to show toolbar containing Virtual Machine action buttons (such as Run,
      Pause, Shutdown) in the details display
    type: bool
    default: true
  ...
  show-toolbar_locked:
    description:
    - >
      If set to true, locks the 'show-toolbar' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.details
  org_virt_manager_virt_manager_details:
    show-toolbar: true
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.details")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.details")

    schema_full_path = "/org/virt-manager/virt-manager/details/"
