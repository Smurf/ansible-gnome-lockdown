...
DOCUMENTATION = r'''
---
module: org_gtk_gtk4_Settings_EmojiChooser
short_description: Manages GNOME GSettings for org.gtk.gtk4.Settings.EmojiChooser
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gtk_gtk4_Settings_EmojiChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gtk_gtk4_Settings_EmojiChooser")

    schema_full_path = "/org/gtk/gtk4/settings/emoji-chooser/"
