...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_shell_extensions_apps-menu")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_shell_extensions_apps-menu")
