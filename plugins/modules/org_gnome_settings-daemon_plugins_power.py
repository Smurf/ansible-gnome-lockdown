...
DOCUMENTATION = r'''
---
module: org_gnome_settings-daemon_plugins_power
...
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins.power
  org_gnome_settings-daemon_plugins_power:
    idle-brightness: 30
    idle-brightness_locked: true
    idle-dim: True
    idle-dim_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_settings-daemon_plugins_power")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_settings-daemon_plugins_power")
