...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_search_providers
...
options:
  disable-external:
    ...
    - "Set to true to disable all external search provider programs,\n        whether\
      \ or not they are independently disabled or enabled.\n        External search providers\
      \ are installed by applications in\n        $XDG_DATA_DIR/gnome-shell/search-providers."
    type: bool
    default: false
  ...
  sort-order:
    ...
    - "Results for applications contained in this list will be displayed in\n        the\
      \ specified order.\n        Results for applications not specified in this list\
...
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.search-providers
  org_gnome_desktop_search_providers:
