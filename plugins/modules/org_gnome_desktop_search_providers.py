...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_search-providers
short_description: Manages GNOME GSettings for org.gnome.desktop.search-providers
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.search-providers' schema.
  - >
...
options:
  disable-external:
    description:
      ...
      - >
        Set to true to disable all external search provider programs, whether or not they are independently disabled or enabled. External search providers are installed by applications in $XDG_DATA_DIR/gnome-shell/search-providers.
    type: bool
    default: false
  disable-external_locked:
    description:
      - >
        If set to true, locks the 'disable-external' key to prevent user modification.
    type: bool
    default: false
  disabled:
    description:
  ...
  disabled_locked:
    description:
      - >
        If set to true, locks the 'disabled' key to prevent user modification.
    type: bool
    default: false
  enabled:
    description:
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.search-providers
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.search-providers")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.search-providers")

    schema_full_path = "/org/gnome/desktop/search-providers/"
