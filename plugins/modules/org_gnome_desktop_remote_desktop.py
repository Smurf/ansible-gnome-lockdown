...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_remote-desktop
short_description: Manages GNOME GSettings for org.gnome.desktop.remote-desktop
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.remote-desktop' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.remote-desktop
  org_gnome_desktop_remote-desktop:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.remote-desktop")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.remote-desktop")

    schema_full_path = "/org/gnome/desktop/remote-desktop/"
