...
DOCUMENTATION = r'''
---
module: org_gnome_shell_extensions_window-list
short_description: Manages GNOME GSettings for org.gnome.shell.extensions.window-list
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.shell.extensions.window-list' schema.
  - >
...
options:
  ...
  grouping-mode_locked:
    description:
      - >
        If set to true, locks the 'grouping-mode' key to prevent user modification.
    type: bool
    default: false
  display-all-workspaces:
    ...
    type: bool
    default: false
  display-all-workspaces_locked:
    description:
      - >
        If set to true, locks the 'display-all-workspaces' key to prevent user modification.
    type: bool
    default: false
  show-on-all-monitors:
    ...
    type: bool
    default: false
  show-on-all-monitors_locked:
    description:
      - >
        If set to true, locks the 'show-on-all-monitors' key to prevent user modification.
    type: bool
    default: false
  embed-previews:
    description:
      - >
        Show workspace previews in window list
      - >
        Description - Schema Blank
    type: bool
    default: true
  embed-previews_locked:
    description:
      - >
        If set to true, locks the 'embed-previews' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.shell.extensions.window-list
  org_gnome_shell_extensions_window-list:
    grouping-mode: "never"
    grouping-mode_locked: true
    display-all-workspaces: false
    display-all-workspaces_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_shell_extensions_window-list")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_shell_extensions_window-list")

    schema_full_path = "/org/gnome/shell/extensions/window-list/"
