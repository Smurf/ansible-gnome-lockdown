...
DOCUMENTATION = r'''
---
module: org_gnome_clocks_state_window
short_description: Manages GNOME GSettings for org.gnome.clocks.state.window
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.clocks.state.window' schema.
  - >
...
options:
  ...
  size_locked:
    description:
    - >
      If set to true, locks the 'size' key to prevent user modification.
    type: bool
    default: false
  panel-id:
    description:
  ...
  panel-id_locked:
    description:
    - >
      If set to true, locks the 'panel-id' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.clocks.state.window
  org_gnome_clocks_state_window:
    maximized: false
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.clocks.state.window")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.clocks.state.window")

    schema_full_path = "/org/gnome/clocks/state/window/"
