...
options:
  ...
  style-scheme:
    description:
    - Style Scheme
    - The style scheme to use by the editor. It may translate this into a dark format
      when available.
    type: str
    default: Adwaita
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.TextEditor")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.TextEditor")
