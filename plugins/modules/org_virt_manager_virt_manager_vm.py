...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_vm
...
options:
  ...
  scaling:
    ...
    - When to scale the VM graphical console. -1 = global default, 0 = never, 1 = only
      when in full screen mode, 2 = Always
    type: int
    default: -1
...
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.vm
  org_virt_manager_virt_manager_vm:
    vm-window-size: (-1, -1)
