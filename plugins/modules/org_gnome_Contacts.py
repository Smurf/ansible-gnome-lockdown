...
DOCUMENTATION = r'''
---
module: org_gnome_Contacts
short_description: Manages GNOME GSettings for org.gnome.Contacts
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_Contacts")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_Contacts")

    schema_full_path = "/org/gnome/Contacts/"
