...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_vmlist_fields
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.vmlist-fields
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.vmlist-fields' schema.
  - >
...
options:
  ...
  disk-usage_locked:
    description:
    - >
      If set to true, locks the 'disk-usage' key to prevent user modification.
    type: bool
    default: false
  network-traffic:
    description:
  ...
  network-traffic_locked:
    description:
    - >
      If set to true, locks the 'network-traffic' key to prevent user modification.
    type: bool
    default: false
  cpu-usage:
    description:
  ...
  cpu-usage_locked:
    description:
    - >
      If set to true, locks the 'cpu-usage' key to prevent user modification.
    type: bool
    default: false
  host-cpu-usage:
    description:
  ...
  host-cpu-usage_locked:
    description:
    - >
      If set to true, locks the 'host-cpu-usage' key to prevent user modification.
    type: bool
    default: false
  memory-usage:
    description:
    - Show memory usage in summary
    - Show memory usage field in the domain list summary view
    type: bool
    default: false
  ...
  memory-usage_locked:
    description:
    - >
      If set to true, locks the 'memory-usage' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.vmlist-fields
  org_virt_manager_virt_manager_vmlist_fields:
    disk-usage: false
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.vmlist-fields")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.vmlist-fields")

    schema_full_path = "/org/virt-manager/virt-manager/vmlist-fields/"
