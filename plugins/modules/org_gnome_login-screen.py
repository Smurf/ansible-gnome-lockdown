...
- name: Configure and lock GNOME desktop settings for org.gnome.login-screen
  org_gnome_login-screen:
    enable-fingerprint-authentication: True
    enable-fingerprint-authentication_locked: true
    enable-smartcard-authentication: True
    enable-smartcard-authentication_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_login-screen")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_login-screen")
