...
DOCUMENTATION = r'''
---
module: org_gtk_settings_debug
short_description: Manages GNOME GSettings for org.gtk.Settings.Debug
description:
  - >
...
options:
  enable-inspector-keybinding:
    ...
    - "If this setting is true, GTK+ lets the user open an interactive\n        debugging\
      \ window with a keybinding. The default shortcuts for\n        the keybinding are\
      \ Control-Shift-I and Control-Shift-D."
    type: bool
    default: false
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.Settings.Debug")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.Settings.Debug")

    schema_full_path = "/org/gtk/settings/debug/"
