...
DOCUMENTATION = r'''
---
module: org_gnome_gnome_system_monitor_openfilestree
short_description: Manages GNOME GSettings for org.gnome.gnome-system-monitor.openfilestree
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.gnome-system-monitor.openfilestree' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.gnome-system-monitor.openfilestree
  org_gnome_gnome_system_monitor_openfilestree:
    sort-col: 0
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.gnome-system-monitor.openfilestree")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.gnome-system-monitor.openfilestree")

    schema_full_path = "/org/gnome/gnome-system-monitor/openfilestree/"
