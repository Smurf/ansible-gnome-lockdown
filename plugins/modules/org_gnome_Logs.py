...
DOCUMENTATION = r'''
---
module: org_gnome_Logs
short_description: Manages GNOME GSettings for org.gnome.Logs
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_Logs")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_Logs")

    schema_full_path = "/org/gnome/logs/"
