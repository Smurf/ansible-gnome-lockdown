...
DOCUMENTATION = r'''
---
module: org_gnome_system_smb
short_description: Manages GNOME GSettings for org.gnome.system.smb
description:
  - >
...
options:
  display-mode:
    ...
    - How SMB devices are displayed in the 'network:///' location. Possible values are
      'merged', 'separate' (the Windows Network folder) and 'disabled'.
    type: str
    default: disabled
  ...
  workgroup:
    description:
    - SMB workgroup
    - The Windows networking workgroup or domain that the user is part of. In order for
      a new workgroup to fully take effect the user may need to log out and log back in.
    type: str
    default: ''
