...
DOCUMENTATION = r'''
---
module: org_freedesktop_tracker3_fts
short_description: Manages GNOME GSettings for org.freedesktop.Tracker3.FTS
description:
  - >
...
options:
  ...
  enable-unaccent:
    description:
    - Enable unaccent
    - "Translate accented characters to the equivalent unaccented. E.g. 'Id\xE9a' to 'Idea'\
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.freedesktop.Tracker3.FTS")
    lock_file_path = os.path.join(locks_dir, "ansible-org.freedesktop.Tracker3.FTS")

    schema_full_path = "/org/freedesktop/tracker/fts/"
