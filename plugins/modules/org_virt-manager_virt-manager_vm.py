...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_virt-manager_virt-manager_vm")
    lock_file_path = os.path.join(locks_dir, "ansible-org_virt-manager_virt-manager_vm")
