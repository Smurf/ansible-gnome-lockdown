...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_break_reminders
short_description: Manages GNOME GSettings for org.gnome.desktop.break-reminders
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.break-reminders' schema.
  - >
...
options:
  selected-breaks:
    description:
    - List of breaks that are currently enabled
  ...
  selected-breaks_locked:
    description:
    - >
      If set to true, locks the 'selected-breaks' key to prevent user modification.
    type: bool
    default: false
'''
...
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.break-reminders
  org_gnome_desktop_break_reminders:
    selected-breaks: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.break-reminders")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.break-reminders")

    schema_full_path = "/org/gnome/desktop/break-reminders/"
