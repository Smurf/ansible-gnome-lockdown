...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_global_shortcuts_application
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.global-shortcuts.application
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.global-shortcuts.application' schema.
  - >
...
options:
  ...
  shortcuts_locked:
    description:
    - >
      If set to true, locks the 'shortcuts' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.global-shortcuts.application
  org_gnome_settings_daemon_global_shortcuts_application:
    shortcuts: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.global-shortcuts.application")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.global-shortcuts.application")
