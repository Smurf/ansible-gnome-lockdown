...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.gtk4.Settings.EmojiChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.gtk4.Settings.EmojiChooser")
