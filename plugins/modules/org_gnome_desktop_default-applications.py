...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_default-applications
short_description: Manages GNOME GSettings for org.gnome.desktop.default-applications
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.default-applications' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.default-applications
  org_gnome_desktop_default-applications:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_default-applications")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_default-applications")

    schema_full_path = "/org/gnome/desktop/applications/"
