...
DOCUMENTATION = r'''
---
module: org_gtk_settings_emojichooser
short_description: Manages GNOME GSettings for org.gtk.Settings.EmojiChooser
description:
  - >
...
options:
  recent-emoji:
    ...
    - "An array of Emoji definitions to show in the Emoji chooser. Each Emoji is\n   \
      \     specified as an array of codepoints, name and shortname. The extra integer\
      \ after this\n        pair is the code of the Fitzpatrick modifier to use in place\
      \ of a 0 in the\n        codepoint array."
    type: str
    default: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.Settings.EmojiChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.Settings.EmojiChooser")

    schema_full_path = "/org/gtk/settings/emoji-chooser/"
