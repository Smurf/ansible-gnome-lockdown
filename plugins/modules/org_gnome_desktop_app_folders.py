...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_app_folders
short_description: Manages GNOME GSettings for org.gnome.desktop.app-folders
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.app-folders' schema.
  - >
...
options:
  folder-children:
    ...
    - "List of relative settings paths at which app-folders are\n        stored. Each\
      \ folder uses the org.gnome.desktop.app-folders.folder\n        schema."
    type: str
    default: []
  ...
  folder-children_locked:
    description:
    - >
      If set to true, locks the 'folder-children' key to prevent user modification.
    type: bool
    default: false
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.app-folders")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.app-folders")

    schema_full_path = "/org/gnome/desktop/app-folders/"
