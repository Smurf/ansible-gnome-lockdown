...
DOCUMENTATION = r'''
---
module: org_gnome_settings-daemon_global-shortcuts
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_settings-daemon_global-shortcuts")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_settings-daemon_global-shortcuts")
