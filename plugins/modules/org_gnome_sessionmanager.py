...
DOCUMENTATION = r'''
---
module: org_gnome_sessionmanager
short_description: Manages GNOME GSettings for org.gnome.SessionManager
description:
  - >
...
options:
  ...
  auto-save-session-one-shot:
    description:
    - Save this session
    - When enabled, gnome-session will automatically save the next session at log out
      even if auto saving is disabled.
    type: bool
    default: false
  ...
  show-fallback-warning:
    ...
    - If enabled, gnome-session will display a warning dialog after login if the session
      was automatically fallen back.
    type: bool
    default: true
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.SessionManager")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.SessionManager")

    schema_full_path = "/org/gnome/gnome-session/"
