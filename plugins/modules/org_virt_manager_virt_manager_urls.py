...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_urls
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.urls
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.urls' schema.
  - >
...
options:
  containers:
    description:
    - Saved list of source URLs
    - Saved list of source URLs used to bootstrap OS containers
    type: str
    default: []
  ...
  containers_locked:
    description:
    - >
      If set to true, locks the 'containers' key to prevent user modification.
    type: bool
    default: false
  urls:
    description:
  ...
  urls_locked:
    description:
    - >
      If set to true, locks the 'urls' key to prevent user modification.
    type: bool
    default: false
  isos:
    description:
    - Saved list of install ISOs
    - Saved list of install ISOs
    type: str
    default: []
  ...
  isos_locked:
    description:
    - >
      If set to true, locks the 'isos' key to prevent user modification.
    type: bool
    default: false
  kickstarts:
    description:
    - Saved list of install kickstarts
    - Saved list of install kickstarts
    type: str
    default: []
  ...
  kickstarts_locked:
    description:
    - >
      If set to true, locks the 'kickstarts' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.urls
  org_virt_manager_virt_manager_urls:
    containers: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.urls")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.urls")

    schema_full_path = "/org/virt-manager/virt-manager/urls/"
