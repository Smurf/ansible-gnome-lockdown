...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_plugins_color
...
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins.color
  org_gnome_settings_daemon_plugins_color:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.plugins.color")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.plugins.color")
