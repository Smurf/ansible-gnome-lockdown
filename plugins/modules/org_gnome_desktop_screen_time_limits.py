...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_screen-time-limits
short_description: Manages GNOME GSettings for org.gnome.desktop.screen-time-limits
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.screen-time-limits' schema.
  - >
...
options:
  history-enabled:
    description:
      - >
        Enable screen time history
      - >
        Enable basic screen time functionality, recording usage data for viewing history.
    type: bool
    default: true
  history-enabled_locked:
    description:
      - >
        If set to true, locks the 'history-enabled' key to prevent user modification.
    type: bool
    default: false
  daily-limit-enabled:
    description:
    ...
    type: bool
    default: false
  daily-limit-enabled_locked:
    description:
      - >
        If set to true, locks the 'daily-limit-enabled' key to prevent user modification.
    type: bool
    default: false
  daily-limit-seconds:
    description:
  ...
  daily-limit-seconds_locked:
    description:
      - >
        If set to true, locks the 'daily-limit-seconds' key to prevent user modification.
    type: bool
    default: false
  grayscale:
    description:
      - >
        Grayscale once limit is reached
      - >
        Whether to make the screen grayscale once the user’s screen time limit is reached.
    type: bool
    default: true
  grayscale_locked:
    description:
      - >
        If set to true, locks the 'grayscale' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.screen-time-limits
  org_gnome_desktop_screen-time-limits:
    history-enabled: true
    history-enabled_locked: true
    daily-limit-enabled: false
    daily-limit-enabled_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.screen-time-limits")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.screen-time-limits")

    schema_full_path = "/org/gnome/desktop/screen-time-limits/"
