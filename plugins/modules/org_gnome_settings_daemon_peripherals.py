...
DOCUMENTATION = r'''
---
module: org_gnome_settings-daemon_peripherals
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.peripherals
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.peripherals' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.peripherals
  org_gnome_settings-daemon_peripherals:
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.peripherals")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.peripherals")

    schema_full_path = "/org/gnome/settings-daemon/peripherals/"
