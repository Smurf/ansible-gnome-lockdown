...
DOCUMENTATION = r'''
---
module: org_gnome_gnome_system_monitor
...
options:
  ...
  cpu-smooth-graph:
    ...
    - If TRUE, system-monitor shows the CPU, Memory, Network, and Disk charts as smoothed
...
- name: Configure and lock GNOME desktop settings for org.gnome.gnome-system-monitor
  org_gnome_gnome_system_monitor:
    window-width: 800
    ...
    net-out-color: '#e66100'

    disk-read-color: '#3584e4'

    disk-write-color: '#e66100'
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.gnome-system-monitor")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.gnome-system-monitor")
