...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_session
short_description: Manages GNOME GSettings for org.gnome.desktop.session
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.session")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.session")

    schema_full_path = "/org/gnome/desktop/session/"
