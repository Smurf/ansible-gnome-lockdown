...
DOCUMENTATION = r'''
---
module: org_gtk_settings_colorchooser
short_description: Manages GNOME GSettings for org.gtk.Settings.ColorChooser
description:
  - >
...
options:
  ...
  selected-color:
    ...
    - "The selected color, described as a tuple whose first member is a\n         boolean\
      \ that is true if a color was selected, and the remaining\n         four members\
      \ are four doubles, specifying RGBA values between\n         0 and 1."
    type: str
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.Settings.ColorChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.Settings.ColorChooser")

    schema_full_path = "/org/gtk/settings/color-chooser/"
