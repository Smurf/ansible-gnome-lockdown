...
DOCUMENTATION = r'''
---
module: org_gnome_loupe
short_description: Manages GNOME GSettings for org.gnome.Loupe
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.Loupe")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.Loupe")

    schema_full_path = "/org/gnome/Loupe/"
