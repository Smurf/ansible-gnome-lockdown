...
DOCUMENTATION = r'''
---
module: org_gnome_shell_world_clocks
short_description: Manages GNOME GSettings for org.gnome.shell.world-clocks
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.shell.world-clocks' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.shell.world-clocks
  org_gnome_shell_world_clocks:
    locations: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.shell.world-clocks")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.shell.world-clocks")

    schema_full_path = "/org/gnome/shell/world-clocks/"
