...
DOCUMENTATION = r'''
---
module: org_gtk_gtk4_settings_colorchooser
short_description: Manages GNOME GSettings for org.gtk.gtk4.Settings.ColorChooser
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.gtk4.Settings.ColorChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.gtk4.Settings.ColorChooser")

    schema_full_path = "/org/gtk/gtk4/settings/color-chooser/"
