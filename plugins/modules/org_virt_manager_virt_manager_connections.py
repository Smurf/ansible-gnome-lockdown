...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_connections
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.connections
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.connections' schema.
  - >
...
options:
  ...
  uris_locked:
    description:
    - >
      If set to true, locks the 'uris' key to prevent user modification.
    type: bool
    default: false
  autoconnect:
    description:
    - Libvirt URIs to connect to on app startup
    - Libvirt URIs to connect to on app startup
    type: str
    default: []
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.connections
  org_virt_manager_virt_manager_connections:
    uris: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.connections")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.connections")

    schema_full_path = "/org/virt-manager/virt-manager/connections/"
