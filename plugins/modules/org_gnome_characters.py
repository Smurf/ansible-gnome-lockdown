...
DOCUMENTATION = r'''
---
module: org_gnome_characters
short_description: Manages GNOME GSettings for org.gnome.Characters
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.Characters")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.Characters")

    schema_full_path = "/org/gnome/Characters/"
