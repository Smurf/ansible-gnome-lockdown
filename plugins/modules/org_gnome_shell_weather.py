...
DOCUMENTATION = r'''
---
module: org_gnome_shell_weather
short_description: Manages GNOME GSettings for org.gnome.shell.weather
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.shell.weather' schema.
  - >
...
options:
  ...
  automatic-location_locked:
    description:
    - >
      If set to true, locks the 'automatic-location' key to prevent user modification.
    type: bool
    default: false
  locations:
    description:
  ...
  locations_locked:
    description:
    - >
      If set to true, locks the 'locations' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.shell.weather
  org_gnome_shell_weather:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.shell.weather")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.shell.weather")

    schema_full_path = "/org/gnome/shell/weather/"
