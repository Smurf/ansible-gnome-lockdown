...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_paths
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.paths
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.paths' schema.
  - >
...
options:
  ...
  image-default_locked:
    description:
    - >
      If set to true, locks the 'image-default' key to prevent user modification.
    type: bool
    default: false
  media-default:
    description:
  ...
  media-default_locked:
    description:
    - >
      If set to true, locks the 'media-default' key to prevent user modification.
    type: bool
    default: false
  screenshot-default:
    description:
  ...
  screenshot-default_locked:
    description:
    - >
      If set to true, locks the 'screenshot-default' key to prevent user modification.
    type: bool
    default: false
  perms-fix-ignore:
    description:
    - Ask about fixing permissions
    - Whether to ask about fixing path permissions
    type: str
    default: []

  perms-fix-ignore_locked:
    description:
    - >
      If set to true, locks the 'perms-fix-ignore' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.paths
  org_virt_manager_virt_manager_paths:
    image-default: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.paths")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.paths")

    schema_full_path = "/org/virt-manager/virt-manager/paths/"
