...
DOCUMENTATION = r'''
---
module: org_gnome_yelp_documents
short_description: Manages GNOME GSettings for org.gnome.yelp.documents
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.yelp.documents' schema.
  - >
...
options:
  ...
  geometry_locked:
    description:
    - >
      If set to true, locks the 'geometry' key to prevent user modification.
    type: bool
    default: false
  bookmarks:
    description:
  ...
  bookmarks_locked:
    description:
    - >
      If set to true, locks the 'bookmarks' key to prevent user modification.
    type: bool
    default: false
  readlater:
    description:
  ...
  readlater_locked:
    description:
    - >
      If set to true, locks the 'readlater' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.yelp.documents
  org_gnome_yelp_documents:
    geometry: (960, 630)
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.yelp.documents")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.yelp.documents")
