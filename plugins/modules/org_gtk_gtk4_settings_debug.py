...
DOCUMENTATION = r'''
---
module: org_gtk_gtk4_settings_debug
short_description: Manages GNOME GSettings for org.gtk.gtk4.Settings.Debug
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gtk.gtk4.Settings.Debug")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gtk.gtk4.Settings.Debug")

    schema_full_path = "/org/gtk/gtk4/settings/debug/"
