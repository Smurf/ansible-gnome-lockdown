...
DOCUMENTATION = r'''
---
module: org_gnome_system_wsdd
short_description: Manages GNOME GSettings for org.gnome.system.wsdd
description:
  - >
...
options:
  display-mode:
    ...
    - How WSDD devices are displayed in the 'network:///' location. Possible values are
      'merged', 'separate' (the WSDD Network folder) and 'disabled'.
    type: str
    default: merged
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.system.wsdd")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.system.wsdd")

    schema_full_path = "/org/gnome/system/wsdd/"
