...
DOCUMENTATION = r'''
---
module: org_gnome_shell_extensions_apps-menu
short_description: Manages GNOME GSettings for org.gnome.shell.extensions.apps-menu
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.shell.extensions.apps-menu' schema.
  - >
...
options:
  ...
  apps-menu-toggle-menu_locked:
    description:
      - >
        If set to true, locks the 'apps-menu-toggle-menu' key to prevent user modification.
    type: bool
    default: false
'''
...
- name: Configure and lock GNOME desktop settings for org.gnome.shell.extensions.apps-menu
  org_gnome_shell_extensions_apps-menu:
    apps-menu-toggle-menu: "["<Alt>F1"]"
    apps-menu-toggle-menu_locked: true
'''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.shell.extensions.apps-menu")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.shell.extensions.apps-menu")

    schema_full_path = "/org/gnome/shell/extensions/apps-menu/"
