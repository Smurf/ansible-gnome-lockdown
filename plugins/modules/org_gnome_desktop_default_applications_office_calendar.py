...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_default_applications_office_calendar
short_description: Manages GNOME GSettings for org.gnome.desktop.default-applications.office.calendar
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.default-applications.office.calendar' schema.
  - >
...
options:
  exec:
    description:
    - Default calendar
    - "Default calendar application\n\n        DEPRECATED: This key is deprecated and\
      \ ignored.\n        The preferred calendar application is the application handling\
      \ the text/calendar mime type."
    type: str
    default: evolution -c calendar

  exec_locked:
    description:
    - >
      If set to true, locks the 'exec' key to prevent user modification.
    type: bool
    default: false
  needs-term:
    description:
    ...
    - "Whether the default calendar application needs a terminal to run.\n\n        DEPRECATED:\
      \ This key is deprecated and ignored.\n        The preferred calendar application\
      \ is the application handling the text/calendar mime type,\n        whether it needs\
      \ a terminal is taken from its desktop file."
    type: bool
    default: false
  ...
  needs-term_locked:
    description:
    - >
      If set to true, locks the 'needs-term' key to prevent user modification.
    type: bool
    default: false
'''

EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.default-applications.office.calendar
  org_gnome_desktop_default_applications_office_calendar:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.default-applications.office.calendar")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.default-applications.office.calendar")

    schema_full_path = "/org/gnome/desktop/applications/office/calendar/"
