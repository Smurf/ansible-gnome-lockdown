...
DOCUMENTATION = r'''
---
module: org_gnome_Terminal_SettingsList
short_description: Manages GNOME GSettings for org.gnome.Terminal.SettingsList
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_Terminal_SettingsList")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_Terminal_SettingsList")
