...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.online-accounts")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.online-accounts")
