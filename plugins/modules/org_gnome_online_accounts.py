...
DOCUMENTATION = r'''
---
module: org_gnome_online_accounts
...
options:
  whitelisted-providers:
    ...
    - "A list of strings representing the providers that are allowed to be loaded (default:\
      \ 'all'). This is only evaluated on startup.\n\n        Deprecated: use goa.conf\
      \ in the system config directory instead, with a key [providers] enable=all instead.\
