...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_plugins_media_keys_custom_keybinding
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.plugins.media-keys.custom-keybinding
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.plugins.media-keys.custom-keybinding' schema.
  - >
...
options:
  ...
  binding_locked:
    description:
    - >
      If set to true, locks the 'binding' key to prevent user modification.
    type: bool
    default: false
  command:
    description:
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins.media-keys.custom-keybinding
  org_gnome_settings_daemon_plugins_media_keys_custom_keybinding:
    name: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.plugins.media-keys.custom-keybinding")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.plugins.media-keys.custom-keybinding")
