...
DOCUMENTATION = r'''
---
module: org_gnome_system_dns_sd
short_description: Manages GNOME GSettings for org.gnome.system.dns_sd
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.system.dns_sd' schema.
  - >
...
options:
  display-local:
    ...
    - How DNS-SD services are displayed in the 'network:///' location. Possible values
      are 'merged', 'separate' (the Local Network folder) and 'disabled'.
    type: str
    default: merged
