...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_plugins_xsettings
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.plugins.xsettings
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.plugins.xsettings' schema.
  - >
...
options:
  ...
  disabled-gtk-modules_locked:
    description:
    - >
      If set to true, locks the 'disabled-gtk-modules' key to prevent user modification.
    type: bool
    default: false
  enabled-gtk-modules:
    description:
  ...
  enabled-gtk-modules_locked:
    description:
    - >
      If set to true, locks the 'enabled-gtk-modules' key to prevent user modification.
    type: bool
    default: false
  overrides:
    description:
  ...
  overrides_locked:
    description:
    - >
      If set to true, locks the 'overrides' key to prevent user modification.
    type: bool
    default: false
'''
...
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.plugins.xsettings
  org_gnome_settings_daemon_plugins_xsettings:
    disabled-gtk-modules: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.plugins.xsettings")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.plugins.xsettings")

    schema_full_path = "/org/gnome/settings-daemon/plugins/xsettings/"
