...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gtk_gtk4_Settings_ColorChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gtk_gtk4_Settings_ColorChooser")
