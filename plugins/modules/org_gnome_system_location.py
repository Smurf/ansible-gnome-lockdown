...
DOCUMENTATION = r'''
---
module: org_gnome_system_location
short_description: Manages GNOME GSettings for org.gnome.system.location
description:
  - >
...
options:
  ...
  max-accuracy-level:
    ...
    - "Configures the maximum level of location accuracy applications are\n        allowed\
      \ to see. Valid options are 'country', 'city', 'neighborhood',\n        'street',\
      \ and 'exact' (typically requires GPS receiver). Please keep in\n        mind that\
      \ this only controls what GeoClue will allow applications to see\n        and they\
      \ can find user's location on their own using network resources\n        (albeit\
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.system.location")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.system.location")

    schema_full_path = "/org/gnome/system/location/"
