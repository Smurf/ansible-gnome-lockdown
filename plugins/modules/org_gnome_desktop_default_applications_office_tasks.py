...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_default_applications_office_tasks
short_description: Manages GNOME GSettings for org.gnome.desktop.default-applications.office.tasks
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.desktop.default-applications.office.tasks' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.desktop.default-applications.office.tasks
  org_gnome_desktop_default_applications_office_tasks:
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.desktop.default-applications.office.tasks")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.desktop.default-applications.office.tasks")

    schema_full_path = "/org/gnome/desktop/applications/office/tasks/"
