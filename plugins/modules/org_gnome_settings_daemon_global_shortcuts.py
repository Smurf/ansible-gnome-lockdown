...
DOCUMENTATION = r'''
---
module: org_gnome_settings_daemon_global_shortcuts
short_description: Manages GNOME GSettings for org.gnome.settings-daemon.global-shortcuts
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.settings-daemon.global-shortcuts' schema.
  - >
...
options:
  ...
  applications_locked:
    description:
    - >
      If set to true, locks the 'applications' key to prevent user modification.
    type: bool
    default: false
'''
...
- name: Configure and lock GNOME desktop settings for org.gnome.settings-daemon.global-shortcuts
  org_gnome_settings_daemon_global_shortcuts:
    applications: []
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.settings-daemon.global-shortcuts")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.settings-daemon.global-shortcuts")

    schema_full_path = "/org/gnome/settings-daemon/global-shortcuts/"
