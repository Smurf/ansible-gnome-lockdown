...
options:
  overlay-key:
    ...
    - "This key will initiate the 'overlay', which is a combination window\n        overview\
      \ and application launching system.  The default is intended\n        to be the\
  ...
  edge-tiling:
    ...
    - "If enabled, dropping windows on vertical screen edges maximizes them\n        vertically\
      \ and resizes them horizontally to cover half of the available\n        area. Dropping\
  ...
  dynamic-workspaces:
    ...
    - "Determines whether workspaces are managed dynamically or\n        whether there's\
      \ a static number of workspaces (determined\n        by the num-workspaces key in\
  ...
  focus-change-on-pointer-rest:
    ...
    - "If set to true, and the focus mode is either 'sloppy' or 'mouse'\n        then\
      \ the focus will not be changed immediately when entering a\n        window, but\
  ...
  draggable-border-width:
    ...
    - "The amount of total draggable borders. If the theme's visible\n          borders\
      \ are not enough, invisible borders will be added to meet\n          this value."
    type: int
    default: 10
  ...
  experimental-features:
    ...
    - "To enable experimental features, add the feature keyword to the list.\n       \
      ...
      \                                 require a restart.\n\n        \u2022 'kms-modifiers'\
      \             \u2014 makes mutter always allocate scanout\n                    \
      \                    buffers with explicit modifiers, if\n                     \
      \                   supported by the driver. Requires a\n                      \
      \                  restart.\n\n        \u2022 'autoclose-xwayland'        \u2014\
      \ automatically terminates Xwayland if all\n                                   \
      \     relevant X11 clients are gone.\n                                        Requires\
      \ a restart.\n\n        \u2022 'variable-refresh-rate'     \u2014 makes mutter dynamically\
