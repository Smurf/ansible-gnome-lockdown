...
DOCUMENTATION = r'''
---
module: org_gnome_settings
short_description: Manages GNOME GSettings for org.gnome.Settings
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.Settings")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.Settings")

    schema_full_path = "/org/gnome/control-center/"
