...
DOCUMENTATION = r'''
---
module: org_gnome_Disks
short_description: Manages GNOME GSettings for org.gnome.Disks
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_Disks")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_Disks")

    schema_full_path = "/org/gnome/Disks/"
