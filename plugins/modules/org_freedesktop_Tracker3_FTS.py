...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_freedesktop_Tracker3_FTS")
    lock_file_path = os.path.join(locks_dir, "ansible-org_freedesktop_Tracker3_FTS")
