...
DOCUMENTATION = r'''
---
module: org_virt_manager_virt_manager_connection
short_description: Manages GNOME GSettings for org.virt-manager.virt-manager.connection
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.virt-manager.virt-manager.connection' schema.
  - >
...
options:
  pretty-name:
    ...
    - Custom connection description, used in the manager window. If empty, the app generates
      a default on demand.
    type: str
    default: ''
  ...
  pretty-name_locked:
    description:
    - >
      If set to true, locks the 'pretty-name' key to prevent user modification.
    type: bool
    default: false
  window-size:
    description:
    - Conn details window dimensions
    - Connection details window dimensions
    type: str
    default: (-1, -1)
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.virt-manager.virt-manager.connection
  org_virt_manager_virt_manager_connection:
    pretty-name: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.virt-manager.virt-manager.connection")
    lock_file_path = os.path.join(locks_dir, "ansible-org.virt-manager.virt-manager.connection")
