...
options:
  ...
  disabled-extensions:
    ...
    - "GNOME Shell extensions have a UUID property; this key lists extensions\n      \
      ...
      \ D-Bus methods on org.gnome.Shell.\n        This key takes precedence over the\
  ...
  allow-extension-installation:
    ...
    - "Allow users to install extensions in their home folder. If disabled,\n        the\
      \ InstallRemoteExtension D-Bus method will fail, and extensions\n        are only\
      \ loaded from system directories on startup.\n        It does not affect extensions\
      \ that are already loaded, so a change\n        only takes full effect on the next\
      \ login."
    type: bool
    default: true
  ...
  remember-mount-password:
    ...
    - "The shell will request a password when an encrypted device or a\n        remote\
      \ filesystem is mounted.  If the password can be saved for\n        future use a\
      \ 'Remember Password' checkbox will be present.\n        This key sets the default\
  ...
  app-picker-layout:
    ...
    - "Layout of the app picker. Each entry in the array is a page. Pages are\n      \
      ...
      \       stored as 'data':\n          \u2022 'position': the position of the application\
      \ icon in the page"
    type: str
    default:
