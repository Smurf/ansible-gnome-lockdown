...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gtk_Settings_EmojiChooser")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gtk_Settings_EmojiChooser")
