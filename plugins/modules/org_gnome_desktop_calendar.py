...
DOCUMENTATION = r'''
---
module: org_gnome_desktop_calendar
short_description: Manages GNOME GSettings for org.gnome.desktop.calendar
description:
  - >
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org_gnome_desktop_calendar")
    lock_file_path = os.path.join(locks_dir, "ansible-org_gnome_desktop_calendar")

    schema_full_path = "/org/gnome/desktop/calendar/"
