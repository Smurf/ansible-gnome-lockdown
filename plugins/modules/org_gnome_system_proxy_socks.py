...
DOCUMENTATION = r'''
---
module: org_gnome_system_proxy_socks
short_description: Manages GNOME GSettings for org.gnome.system.proxy.socks
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.system.proxy.socks' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.system.proxy.socks
  org_gnome_system_proxy_socks:
    host: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.system.proxy.socks")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.system.proxy.socks")

    schema_full_path = "/system/proxy/socks/"
