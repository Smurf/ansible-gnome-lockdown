...
DOCUMENTATION = r'''
---
module: org_gnome_system_proxy_https
short_description: Manages GNOME GSettings for org.gnome.system.proxy.https
description:
  - >
    This module allows for the configuration of GSettings keys within the 'org.gnome.system.proxy.https' schema.
  - >
...
EXAMPLES = r'''
- name: Configure and lock GNOME desktop settings for org.gnome.system.proxy.https
  org_gnome_system_proxy_https:
    host: ''
...
def main():
    ...
    settings_file_path = os.path.join(settings_dir, "00-ansible-org.gnome.system.proxy.https")
    lock_file_path = os.path.join(locks_dir, "ansible-org.gnome.system.proxy.https")

    schema_full_path = "/system/proxy/https/"
